    ...
    const Projector &projector)
{
    ...
    for (const auto &triangle : faces)
    {
        ...
        drawLine(static_cast<int>(p1.x), static_cast<int>(p1.y), static_cast<int>(p2.x), static_cast<int>(p2.y), lineColor);
        drawLine(static_cast<int>(p2.x), static_cast<int>(p2.y), static_cast<int>(p3.x), static_cast<int>(p3.y), lineColor);
        drawLine(static_cast<int>(p3.x), static_cast<int>(p3.y), static_cast<int>(p1.x), static_cast<int>(p1.y), lineColor);
